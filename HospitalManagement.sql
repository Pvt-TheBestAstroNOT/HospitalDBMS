...
CREATE TABLE `payments` (
  ...
  `CardIdOrUpiId` varchar(100) DEFAULT NULL,
  `Date` date DEFAULT NULL,
  `PatientId` int DEFAULT NULL,
...
INSERT INTO `payments` VALUES (1,150.00,0.00,'Cash',NULL,'2024-04-29',NULL),(2,200.00,20.00,'Credit Card','**** **** **** 1234','2024-04-30',NULL),(3,5000.00,500.00,'Credit Card','1234-5678-9876-5432','2024-01-01',1),(4,7500.00,750.00,'Debit Card','9876-5432-1234-5678','2024-01-02',2),(5,6000.00,600.00,'UPI','upi_id_12345','2024-01-03',3),(6,8000.00,800.00,'Credit Card','4321-8765-5678-1234','2024-01-04',4),(7,4500.00,450.00,'Cash',NULL,'2024-01-05',5);
...
INSERT INTO `rooms` VALUES ('Occupied',2,3,'2024-04-29',1),('Vacant',NULL,NULL,NULL,2),('Occupied',1,5,'2024-01-01',101),('Occupied',2,3,'2024-01-02',102),('Occupied',3,7,'2024-01-03',103),('Occupied',4,4,'2024-01-04',104),('Occupied',5,6,'2024-01-05',105);
...
-- Dump completed on 2024-10-13 15:53:20
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-06-01 15:14:05',NULL),('diagnostics.include_raw','OFF','2024-06-01 15:14:05',NULL),('ps_thread_trx_info.max_length','65535','2024-06-01 15:14:05',NULL),('statement_performance_analyzer.limit','100','2024-06-01 15:14:05',NULL),('statement_performance_analyzer.view',NULL,'2024-06-01 15:14:05',NULL),('statement_truncate_len','64','2024-06-01 15:14:05',NULL);
...
-- Dump completed on 2024-10-13 15:53:22
