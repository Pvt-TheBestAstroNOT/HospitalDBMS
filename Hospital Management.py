...
def installAllRequiredPackages():
    ...
    print(
        "All required packages have been installed. The program will soft-restart now."
    )
    sleep(3)
    system("cls")
...
def insert_doctor(connection):
    ...
    password = password_create(
        "Create a password (Leave it blank to cancel creation): "
    )
    if password == -1:
        return -1
...
def update_patient(connection, attribute, patientid, typeofmsg):
    ...
    if typeofmsg == "int":
        ...
        cursor.execute(
            "Update patient set %s=%s where PatientId=%s" % (attribute, inp, patientid)
        )
        ...
        cursor.execute(
            "Update patient set %s='%s' where PatientId=%s"
            % (attribute, inp, patientid)
        )
    elif typeofmsg == "date":
...
def update_doctor(connection, attribute, doctorid, typeofmsg):
    ...
    if typeofmsg == "int":
        inp = integer_input("Please enter the new value: ")
        cursor.execute(
            "Update doctor set %s=%s where DoctorId=%s" % (attribute, inp, doctorid)
        )
    elif typeofmsg == "float":
        inp = float_input("Please enter the new value: ")
        cursor.execute(
...
def update_appointment(connection, attribute, appid, typeofmsg):
    ...
    if typeofmsg == "int":
        inp = integer_input("Please enter the new value: ")
        cursor.execute(
            "Update Appointments set %s=%s where AppointmentId=%s"
            % (attribute, inp, appid)
        )
    elif typeofmsg == "float":
        inp = float_input("Please enter the new value: ")
...
def deletedoctor(connection, docid):
    """Deletes the doctor record for the corresponding doctorid
...
def deletepatientforeign(connection, patid):
    """deletes all foreign key values associated with patient records

    Args:
        connection : mysql.connector.connect
        patid (int): patient id for which the foreign key values are to be deleted
    """
    cursor = connection.cursor()
    ...
    cursor.execute(
        "UPDATE payments SET patientid = NULL WHERE patientid = %s;", (patid,)
    )
    cursor.execute("UPDATE rooms SET patientid = NULL WHERE patientid = %s;", (patid,))
    cursor.execute(
        "UPDATE patient SET guardianid = NULL WHERE guardianid = %s;", (patid,)
    )
...
def dateinput(
    ...
    '''simplified way to make the user input date

    Args:
        string (str): The personalised message you would want to show the user

    Returns:
        date: date in a string format that can be used directly as input for MySQL
    '''
    print(string)
    ...
    match create_menu(
        ...
        case 1:
            match create_menu(
                ...
                case 3:
                    password = input(
                        "Enter the password given to you by the admin/recruiter: "
                    )
                    if password == "doc":
                ...
                match create_menu(
                    ...
                    case 2:
                        match create_menu(
                            ...
                            case 1:
                                update_patient(
                                    connection, "GuardianId", patientid, "int"
                                )
                            case 2:
                            ...
                            case 7:
                                update_patient(
                                    connection, "password", patientid, "password"
                                )
                            case 8:
        ...
        case 3:
            ...
            while True:
                match create_menu(
                    ...
                    case 2:
                        match create_menu(
                            ["Password", "Name", "Cancel"],
                            "Select what you want to edit:",
                        ):
                            case 1:
                                update_doctor(
                                    connection, "Password", doctorid, "password"
                                )
                            case 2:
                                update_doctor(
                                    connection, "DoctorName", doctorid, "text"
                                )
                            case 3:
                                pass
                    case 3:
                    ...
                    case 4:
                        ...
                        if record == []:
                            print(
                                "The patient ID specified does not exist please try again"
                            )
                            sleep(3)
                            continue
                        table = PrettyTable()
                    ...
                    match create_menu(
                        ...
                        case 3:
                            ...
                            match create_menu(
                                ...
                                case 1:
                                    update_appointment(
                                        connection, "DoctorId", appid, "int"
                                    )
                                case 2:
                                    update_appointment(
                                        connection, "PatientId", appid, "int"
                                    )
                                case 3:
                                    update_appointment(
                                        connection, "PaymentId", appid, "int"
                                    )
                                case 4:
                                    update_appointment(
                                        connection, "Date", appid, "date"
                                    )
                                case 5:
                                    update_appointment(
                                        connection, "Time", appid, "time"
                                    )
                                case 6:
                                    pass
                        case 4:
                ...
                while True:
                    ...
                    match create_menu(
                        ...
                        case 1:
                            ...
                            if record == []:
                                print(
                                    "The patientid specified does not exist please try again"
                                )
                                sleep(3)
                                continue
                        ...
                        case 2:
                            ...
                            if record == []:
                                print(
                                    "The guardianid specified does not exist... please try again"
                                )
                                sleep(3)
                                continue
                        ...
                        case 3:
                            ...
                            if record == []:
                                print(
                                    "The doctorid specified does not exist. please check the credentials and try again."
                                )
                                sleep(3)
                                continue
                        ...
                        case 4:
                            ...
                            if record == []:
                                print(
                                    "The doctorid specified does not exist please try again"
                                )
                                sleep(3)
                                continue
                            tempblockenter()
                            match create_menu(
                                ...
                                case 1:
                                    update_doctor(
                                        connection, "Designation", doctorid, "text"
                                    )
                                case 2:
                                    update_doctor(
                                        connection, "Salary", doctorid, "float"
                                    )
                                case 3:
                                    update_doctor(
                                        connection, "Bonus", doctorid, "float"
                                    )
                                case 4:
                                    update_doctor(
                                        connection, "Department", doctorid, "text"
                                    )
                                case 5:
                                    pass
                        case 5:
        ...
        case 6:
            print(
                "Closing the program. Thank you for using the Hospital Database Managment System"
            )
            sleep(3)
            exit()
